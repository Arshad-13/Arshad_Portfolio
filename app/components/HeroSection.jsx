             ...
             <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                    ...
                    <div className="text-center z-10 relative">
                        ...
                        <div className="text-5xl font-bold text-white font-heading tracking-tighter glitch-effect" data-text={`LVL. ${level}`}>LVL. {level}</div>
                        <div className="text-xs text-primary font-mono mt-2 border-t border-primary/30 pt-1">EXP: {exp}%</div>
                        
                        {/* Progress Bar */}
                        <div className="w-32 h-1 bg-white/10 mt-2 rounded-full overflow-hidden mx-auto">
                            <div className="h-full bg-primary transition-all duration-1000" style={{ width: `${exp}%` }} />
                        </div>
                    </div>
                </motion.div>
             </div>
