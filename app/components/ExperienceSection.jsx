...
const experiences = [
  {
    ...
    description:
      "Developed a hybrid ensemble model to solve a complex multi-label classification problem: automatically identifying and classifying the roles of telescope facilities in astrophysical literature. Achieved 4th Place on the official Kaggle leaderboard, leading to a co-authored paper Accepted at WASP 2025. Engineered a two-level model fusing a domain-adapted astroBERT with a rule-based keyword classifier and XGBoost meta-learners.",
  ...
  },
  {
    ...
    description:
      "Developed StyleSphere, a social hub for sharing looks and joining live streams. Built an e-commerce Marketplace with smart search, Razorpay checkout, and Shiprocket integration. Integrated Zyra AI Chatbot (LangChain + Gemini 2.5 Flash) for styling tips. Deployed an ML-powered Virtual Try-On feature using Leffa ML.",
  ...
  },
  {
    ...
    description:
      "Led a team to design a CNN model to autonomously classify materials as Biodegradable or Non-Biodegradable. Designed and trained a deep CNN architecture achieving 97% accuracy. Deployed the model on a Raspberry Pi using OpenCV for real-time classification from a live webcam feed.",
                            ...
                            <div className="tech-border p-6 bg-black/60 group hover:bg-black/80 transition-colors">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className={`text-[10px] font-mono px-2 py-0.5 rounded border ${
                                        exp.status === 'PUBLISHED' ? 'bg-purple-500/10 text-purple-400 border-purple-500/20' :
